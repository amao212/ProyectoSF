...
(
	Id_Cliente					VARCHAR(30) 	NOT NULL AUTOINCREMENT,
...
(
	Id_ProductoCatalogo				varchar(30)		NOT NULL AUTOINCREMENT,
...
CREATE TABLE ROL
(	
	Id_Rol					VARCHAR(30)	NOT NULL AUTOINCREMENT,
...
(
	Id_Usuario					VARCHAR(30)	NOT NULL AUTOINCREMENT,
...
(
	Id_Empleado					VARCHAR(30)	NOT NULL AUTOINCREMENT,
	Id_Rol						VARCHAR(30)	NOT NULL,
...
(
	Id_Credencial					VARCHAR(30)	NOT NULL AUTOINCREMENT,
...
(
	Id_Registro				VARCHAR(30)	NOT NULL AUTOINCREMENT,
...
(
	Id_Inventario					VARCHAR(30)	NOT NULL AUTOINCREMENT,
...
(
	Id_ProducCatalo			  VARCHAR(30)	NOT NULL AUTOINCREMENT,
...
(
	Id_DetalleFactura			VARCHAR(30)	NOT NULL AUTOINCREMENT,
	Id_ProductoCatalogo			VARCHAR(30)	NOT NULL,
...
(
	Id_Factura			VARCHAR(30)	NOT NULL AUTOINCREMENT,
...
(
	Id_FormaPago	VARCHAR(40)		NOT NULL AUTOINCREMENT:,
