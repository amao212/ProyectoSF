...
(
	Id_Cliente					VARCHAR(30) AUTOINCREMENT	NOT NULL,
...
(
	...
	CONSTRAINT PK_PRODUTO_CATALOGO PRIMARY KEY  (Id_ProductoCatalogo)
);
...
(
	...
	CONSTRAINT PK_PRODUCTOS_CATALOGO PRIMARY KEY  (Id_ProducCatalo)
);
...
(
	...
	CONSTRAINT PK_FORMA_DE_PAGO PRIMARY KEY (Id_FormaPago)
);